...
export const ColumnFamilyConfigStruct = koffi.struct(
...
// Default config
export const tidesdb_default_column_family_config = lib.func(
  "tidesdb_column_family_config_t tidesdb_default_column_family_config()",
);
export const tidesdb_default_config = lib.func(
  "tidesdb_config_t tidesdb_default_config()",
);

// Column family operations
export const tidesdb_create_column_family = lib.func(
  "int tidesdb_create_column_family(tidesdb_t *db, const char *name, tidesdb_column_family_config_t *config)",
);
export const tidesdb_drop_column_family = lib.func(
  "int tidesdb_drop_column_family(tidesdb_t *db, const char *name)",
);
export const tidesdb_rename_column_family = lib.func(
  "int tidesdb_rename_column_family(tidesdb_t *db, const char *old_name, const char *new_name)",
);
export const tidesdb_clone_column_family = lib.func(
  "int tidesdb_clone_column_family(tidesdb_t *db, const char *source_name, const char *dest_name)",
);
export const tidesdb_get_column_family = lib.func(
  "tidesdb_column_family_t *tidesdb_get_column_family(tidesdb_t *db, const char *name)",
);
export const tidesdb_list_column_families = lib.func(
  "int tidesdb_list_column_families(tidesdb_t *db, _Out_ char ***names, _Out_ int *count)",
);

// Transaction operations
export const tidesdb_txn_begin = lib.func(
  "int tidesdb_txn_begin(tidesdb_t *db, _Out_ tidesdb_txn_t **txn)",
);
export const tidesdb_txn_begin_with_isolation = lib.func(
  "int tidesdb_txn_begin_with_isolation(tidesdb_t *db, int isolation, _Out_ tidesdb_txn_t **txn)",
);
export const tidesdb_txn_put = lib.func(
  "int tidesdb_txn_put(tidesdb_txn_t *txn, tidesdb_column_family_t *cf, const uint8_t *key, size_t key_size, const uint8_t *value, size_t value_size, int64_t ttl)",
);
export const tidesdb_txn_get = lib.func(
  "int tidesdb_txn_get(tidesdb_txn_t *txn, tidesdb_column_family_t *cf, const uint8_t *key, size_t key_size, _Out_ uint8_t **value, _Out_ size_t *value_size)",
);
...
export const tidesdb_txn_rollback = lib.func(
  "int tidesdb_txn_rollback(tidesdb_txn_t *txn)",
);
export const tidesdb_txn_reset = lib.func(
  "int tidesdb_txn_reset(tidesdb_txn_t *txn, int isolation)",
);
export const tidesdb_txn_free = lib.func(
  "void tidesdb_txn_free(tidesdb_txn_t *txn)",
);

// Savepoint operations
export const tidesdb_txn_savepoint = lib.func(
  "int tidesdb_txn_savepoint(tidesdb_txn_t *txn, const char *name)",
);
export const tidesdb_txn_rollback_to_savepoint = lib.func(
  "int tidesdb_txn_rollback_to_savepoint(tidesdb_txn_t *txn, const char *name)",
);
export const tidesdb_txn_release_savepoint = lib.func(
...
export const tidesdb_iter_seek = lib.func(
  "int tidesdb_iter_seek(tidesdb_iter_t *iter, const uint8_t *key, size_t key_size)",
);
export const tidesdb_iter_seek_for_prev = lib.func(
  "int tidesdb_iter_seek_for_prev(tidesdb_iter_t *iter, const uint8_t *key, size_t key_size)",
);
export const tidesdb_iter_seek_to_first = lib.func(
  "int tidesdb_iter_seek_to_first(tidesdb_iter_t *iter)",
);
export const tidesdb_iter_seek_to_last = lib.func(
  "int tidesdb_iter_seek_to_last(tidesdb_iter_t *iter)",
);
export const tidesdb_iter_next = lib.func(
  "int tidesdb_iter_next(tidesdb_iter_t *iter)",
);
export const tidesdb_iter_prev = lib.func(
  "int tidesdb_iter_prev(tidesdb_iter_t *iter)",
);
export const tidesdb_iter_valid = lib.func(
  "int tidesdb_iter_valid(tidesdb_iter_t *iter)",
);
export const tidesdb_iter_key = lib.func(
  "int tidesdb_iter_key(tidesdb_iter_t *iter, _Out_ uint8_t **key, _Out_ size_t *key_size)",
);
export const tidesdb_iter_value = lib.func(
  "int tidesdb_iter_value(tidesdb_iter_t *iter, _Out_ uint8_t **value, _Out_ size_t *value_size)",
);
export const tidesdb_iter_free = lib.func(
...
export const tidesdb_is_flushing = lib.func(
  "int tidesdb_is_flushing(tidesdb_column_family_t *cf)",
);
export const tidesdb_is_compacting = lib.func(
  "int tidesdb_is_compacting(tidesdb_column_family_t *cf)",
);
export const tidesdb_purge = lib.func("int tidesdb_purge(tidesdb_t *db)");
export const tidesdb_purge_cf = lib.func(
  "int tidesdb_purge_cf(tidesdb_column_family_t *cf)",
);
export const tidesdb_backup = lib.func(
  "int tidesdb_backup(tidesdb_t *db, char *dir)",
);
export const tidesdb_checkpoint = lib.func(
  "int tidesdb_checkpoint(tidesdb_t *db, const char *checkpoint_dir)",
);

// Comparator operations
export const tidesdb_register_comparator = lib.func(
  "int tidesdb_register_comparator(tidesdb_t *db, const char *name, void *fn, const char *ctx_str, void *ctx)",
);
export const tidesdb_get_comparator = lib.func(
...
export const tidesdb_cf_config_save_to_ini = lib.func(
  "int tidesdb_cf_config_save_to_ini(const char *ini_file, const char *section_name, tidesdb_column_family_config_t *config)",
);
export const tidesdb_cf_update_runtime_config = lib.func(
  "int tidesdb_cf_update_runtime_config(tidesdb_column_family_t *cf, tidesdb_column_family_config_t *new_config, int persist_to_disk)",
);

// Statistics operations
export const tidesdb_get_stats = lib.func(
  "int tidesdb_get_stats(tidesdb_column_family_t *cf, _Out_ tidesdb_stats_t **stats)",
);
export const tidesdb_free_stats = lib.func(
  "void tidesdb_free_stats(tidesdb_stats_t *stats)",
);
export const tidesdb_get_cache_stats = lib.func(
  "int tidesdb_get_cache_stats(tidesdb_t *db, _Out_ tidesdb_cache_stats_t *stats)",
);

// Commit hook operations
export const tidesdb_cf_set_commit_hook = lib.func(
